...
# three layers: sensory, feature and output layer
# Sensory layer: 45x45 interconnected excitatory neurons
# Feature layer: 45x45 interconnected excitatory neurons + 15x15 inhibitory neurons
# Output layer: 15x15 excitatory neurons
...
for t in range(time):
    ...
    for j in range(1, 3*image_height+1):
        for i in range(1, 3*image_width+1):
            sensory_layer[j][i].evaluate_state(5)
